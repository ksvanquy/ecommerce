          ...
          <div className="flex items-center space-x-2.5">
            ...
            <div>
              <h3 className="font-semibold text-sm text-slate-900 leading-tight">
                Giỏ hàng của bạn (Mini-Cart)
              </h3>
              <p className="text-[11px] text-slate-500 font-medium">
                {count} {count === 1 ? 'sản phẩm' : 'sản phẩm'} • Giai đoạn 3 (Client State)
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-1">
            {items.length > 0 && (
              <button
                ...
                id="btn-drawer-clear"
                onClick={clearCart}
                className="text-[11px] text-slate-500 hover:text-rose-600 px-2 py-1 rounded hover:bg-rose-50 transition"
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-1">
                      ...
                      <button
                        ...
                        className="text-slate-400 hover:text-rose-600 p-0.5 rounded transition opacity-60 group-hover:opacity-100"
                        title="Xóa khỏi giỏ"
                      >
                    ...
                    <div className="flex items-center justify-between mt-2 pt-2 border-t border-slate-200/50">
                      <div className="flex items-center border border-slate-200 rounded-md bg-white shadow-2xs">
                        <button
                          ...
                          className="w-6 h-6 flex items-center justify-center text-slate-600 hover:bg-slate-100 transition rounded-l"
                        ...
                        <button
                          ...
                          onClick={() => updateQuantity(product.id, quantity + 1)}
                          disabled={isMax}
                          className="w-6 h-6 flex items-center justify-center text-slate-600 hover:bg-slate-100 disabled:opacity-40 disabled:hover:bg-transparent transition rounded-r"
          ...
          <div className="p-4 border-t border-slate-200 bg-slate-50/90 space-y-3">
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="flex items-center justify-center gap-1.5 text-[11px] text-slate-400">
                ...
                <span>Dữ liệu lưu tự động ở LocalStorage (Client State)</span>
              </div>
            </div>
          </div>
        )}
